...
export const SEO_CONTENTS: Record<string, Partial<ToolConfig>> = {
  ...
  'emi-calculator': {
    ...
    howToSteps: [
      {
        name: 'Enter Loan Principal',
        text: 'Input the total amount you wish to borrow (e.g. ₹10,00,000) using the slider or input box.',
      },
      {
        name: 'Set Interest Rate',
        text: 'Enter the annual interest rate offered by the lender (e.g. 8.5%).',
      },
      {
        name: 'Choose Loan Tenure',
        text: 'Select the duration of the loan in years or months (e.g. 10 years).',
      },
      {
        name: 'Analyze Amortization Schedule',
        text: 'Scroll down to review the monthly payment breakdown and download it as CSV if needed.',
      },
    ],
    faq: [
      {
        ...
        answer:
          'The mathematical formula for calculating EMI is: EMI = P × r × (1 + r)^n / ((1 + r)^n - 1) where P is the Principal, r is the monthly interest rate, and n is the number of monthly installments.',
      },
      {
        question: 'How does loan prepayment affect my EMI?',
        answer:
          'Making a prepayment reduces the outstanding principal balance. This allows you to either lower your future monthly EMI amount or keep the EMI same and reduce the remaining tenure.',
      },
      {
        question: 'Can I calculate EMI for different types of loans?',
        answer:
          'Yes, this calculator works for Home Loans, Personal Loans, Car Loans, Education Loans, and any other standard reducing balance loan products.',
      },
    ],
  },
  'sip-calculator': {
    longDescription:
      'A Systematic Investment Plan (SIP) is an investment vehicle offered by mutual funds, allowing investors to invest small amounts periodically instead of as a lump-sum. The frequency of investment is usually weekly, monthly or quarterly.',
    benefits: [
    ...
    examples: [
      {
        input: 'Monthly Investment: ₹5,000, Expected Return: 12%, Tenure: 15 Years',
        output: 'Total Invested: ₹9,00,000, Estimated Returns: ₹16,22,880, Total Value: ₹25,22,880',
      },
    ],
    howToSteps: [
      {
        name: 'Set Monthly Contribution',
        text: 'Enter the amount you wish to invest every month (e.g. ₹5,000).',
      },
      {
        name: 'Enter Expected Returns',
        text: 'Input the projected annual rate of return (e.g. 12% for historical equity mutual funds).',
      },
      {
        name: 'Choose Investment Period',
        text: 'Select the total number of years you plan to stay invested (e.g. 15 years).',
      },
      {
        name: 'Evaluate Estimated Wealth',
        text: 'Review the total returns and the wealth progression charts below.',
      },
    ],
    faq: [
      {
        ...
        answer:
          'Rupee Cost Averaging means you invest a fixed sum at regular intervals. When markets fall, you get more units, and when they rise, you get fewer units. Over time, your average cost per unit reduces, smoothing out volatility.',
      },
      {
        question: 'Can I modify or pause my SIP anytime?',
        answer:
          'Yes, you can pause, stop, or edit the SIP amount anytime without penalties, making it highly flexible compared to traditional saving deposits.',
      },
      {
        question: 'What rate of return should I expect?',
        answer:
          'While returns are not guaranteed, historical equity mutual funds in India have generally returned between 12% and 15% annually over a 7+ year period.',
      },
    ],
  },
  'gst-calculator': {
    longDescription:
      'The Goods and Services Tax (GST) is an indirect tax used in India and other nations on the supply of goods and services. Our GST Calculator allows business owners, freelancers, and consumers to calculate net price, gross price, and tax amounts.',
    benefits: [
    ...
    howToSteps: [
      {
        name: 'Select Mode',
        text: 'Choose whether you want to Add GST or Remove GST from your target amount.',
      },
      { name: 'Enter Amount', text: 'Input the base price or final gross price.' },
      {
        name: 'Choose GST Rate',
        text: 'Select a standard tax slab (5%, 12%, 18%, 28%) or enter a custom rate.',
      },
    ],
    faq: [
      {
        ...
        answer:
          'CGST (Central GST) and SGST (State GST) are applied on intrastate sales and split equally. IGST (Integrated GST) is applied on interstate transactions and goes to the Central Government.',
      },
      {
        question: 'How do I extract GST from a total amount?',
        answer:
          'To remove GST, the formula is: GST Amount = Original Cost - (Original Cost * (100 / (100 + GST%))).',
      },
    ],
  },
  'tip-calculator': {
    longDescription:
      'A Tip Calculator helps you quickly compute tips, split restaurant checks, and manage group dinners without head-scratching calculations.',
    benefits: [
    ...
    faq: [
      {
        ...
        answer:
          'A tip of 15% to 20% is considered standard in most casual and fine-dining restaurants across North America and Europe.',
      },
    ],
  },
  'compound-interest-calculator': {
    ...
    howToSteps: [
      ...
      {
        name: 'Set Rate & Period',
        text: 'Set the annual interest rate percentage and tenure in years.',
      },
      {
        name: 'Select Frequency',
        text: 'Choose your compounding intervals (e.g., Monthly, Quarterly, Annually).',
      },
    ],
    faq: [
      {
        ...
        answer:
          'The Rule of 72 is a quick formula to estimate when your investment will double. Divide 72 by your annual interest rate to find the approximate number of years (e.g., 72 / 12% return = 6 years).',
      },
    ],
  },
  ...
  'json-formatter': {
    longDescription:
      'JSON (JavaScript Object Notation) is a lightweight data-interchange format. It is easy for humans to read and write and easy for machines to parse and generate. The JSON Formatter helps format, validate, minify, and clean JSON payloads.',
    benefits: [
    ...
    howToSteps: [
      {
        ...
        text: 'Paste your raw JSON text into the input panel or click Upload to select a local file.',
      },
      {
        name: 'Select Formatting Depth',
        text: 'Choose your preferred indentation spacing (e.g. 2 spaces, 4 spaces, or Tab).',
      },
      {
        name: 'Format or Minify',
        text: 'Click Format to beautify the code with syntax highlighting, or click Minify to compact it.',
      },
      {
        name: 'Copy or Download Output',
        text: 'Use the Copy Button to save the result to your clipboard or download it as a .json file.',
      },
    ],
    faq: [
      {
        ...
        answer:
          'No. All validation and formatting happen locally in your browser using pure client-side JavaScript. No data is transmitted externally.',
      },
      {
        question: 'Why does my JSON parsing fail?',
        answer:
          'Common mistakes include trailing commas, single quotes instead of double quotes, or missing quotes around property keys. The validator highlights these errors with line numbers.',
      },
      {
        question: 'What is the difference between Formatted and Minified JSON?',
        answer:
          'Formatted JSON includes spacing, line breaks, and indentation for human readability. Minified JSON strips out all whitespace and newlines to create the smallest possible file size for server transmission.',
      },
    ],
  },
  base64: {
    ...
    howToSteps: [
      {
        name: 'Select Mode',
        text: 'Choose Encode to turn text to base64, or Decode to convert it back.',
      },
    ...
    faq: [
      {
        ...
        answer:
          'No. Base64 is an encoding format used to transmit data, not to secure it. It can be easily decoded by anyone and offers zero cryptographic security.',
      },
    ],
  },
  'uuid-generator': {
    longDescription:
      'A Universally Unique Identifier (UUID) is a 128-bit label used for information in computer systems. We generate version 4 UUIDs (which are cryptographically secure random values) and version 1 UUIDs (time-based values).',
    benefits: [
  ...
  'hash-generator': {
    longDescription:
      'Cryptographic hash functions process arbitrary data to output fixed-size checksum strings. This generator supports MD5, SHA-1, SHA-256, and SHA-512 checksum calculations client-side.',
    benefits: [
  ...
  'regex-tester': {
    longDescription:
      'Regular expressions (regex) are sequences of characters that define search patterns. This tester helps developers validate regular expression matches with real-time text highlighting and sub-group captures.',
    benefits: [
  ...
  'password-generator': {
    longDescription:
      'A secure password generator constructs random passwords based on specific character rules (capital letters, lowercase, numbers, and symbols). This tool uses entropy-based calculations to output strong passwords.',
    benefits: [
    ...
    howToSteps: [
      ...
      {
        name: 'Set Options',
        text: 'Toggle numbers, uppercase, symbols, and look-alike characters.',
      },
    ],
  },
  'jwt-decoder': {
    longDescription:
      'JSON Web Token (JWT) is a proposed Internet standard for creating data access tokens. Our JWT Decoder parses header parameters and claim payloads instantly.',
    benefits: [
  ...
  'timestamp-converter': {
    longDescription:
      'Unix epoch time measures the number of seconds that have elapsed since January 1, 1970. This tool translates raw Unix timestamps to local and UTC date formats.',
    benefits: [
  ...
  'word-counter': {
    longDescription:
      'A Word Counter is a text analysis utility that measures words, characters, sentences, paragraphs, and reading times for document drafts.',
    benefits: [
    ...
    howToSteps: [
      { name: 'Paste Text', text: 'Type or paste your text draft.' },
      {
        ...
        text: 'Review word count, character count, and keyword frequencies instantly.',
      },
    ],
  },
  'case-converter': {
    longDescription:
      'A Case Converter changes text capitalization rules across paragraphs. It supports camelCase, PascalCase, snake_case, UPPERCASE, lowercase, and Title Case.',
    benefits: [
    ...
    howToSteps: [
      { name: 'Input Text', text: 'Paste your sentence or paragraph.' },
      {
        ...
        text: 'Click any formatting option to instantly transform casing.',
      },
    ],
  },
  'text-diff': {
  ...
  'markdown-editor': {
    longDescription:
      'Markdown is a lightweight markup language for creating formatted text using a plain-text editor. This editor renders real-time HTML previews next to your markdown input.',
    benefits: [
  ...
  'image-compress': {
    longDescription:
      'Image compression is the process of encoding digital images with fewer bits than the original representation. This compressor uses browser canvas capabilities to compress JPEG, PNG, and WebP images instantly.',
    benefits: [
    ...
    examples: [
      {
        input: 'Original PNG: 4.2 MB, Target Quality: 80%',
        output: 'Compressed WebP: 840 KB (80% Size Reduction)',
      },
    ],
    howToSteps: [
      ...
      {
        name: 'Adjust Quality',
        text: 'Drag the slider to adjust target quality. Live output updates size estimation automatically.',
      },
      {
        name: 'Review Preview',
        text: 'Compare the visual clarity and final size reduction readouts.',
      },
    ...
    faq: [
      {
        ...
        answer:
          'Yes. PNG transparency is preserved. If you convert transparent PNG to JPEG format, the transparent background will automatically render as white.',
      },
      {
        question: 'What is a good target quality for web images?',
        answer:
          'A quality level between 75% and 85% offers the best balance, saving up to 80% of file size while keeping visual artifacts invisible to the human eye.',
      },
      {
        question: 'Are my images uploaded to any server?',
        answer:
          'No. All resizing and compression are done 100% locally in your browser using HTML5 Canvas. Your private photos never leave your device.',
      },
    ],
  },
  'image-resize': {
    longDescription:
      'An image resizer modifies pixel dimensions of photos using client-side canvas scaling filters to ensure high visual quality.',
    benefits: [
    ...
    howToSteps: [
      { name: 'Select Image', text: 'Choose an image file.' },
      {
        ...
        text: 'Set target width or height (aspect ratio is locked by default).',
      },
  ...
  'image-crop': {
    longDescription:
      'Image cropping trims outer borders of photographs to highlight subjects or conform to specific aspect ratios.',
    benefits: [
  ...
  'qr-generator': {
    longDescription:
      'Quick Response (QR) codes are matrix barcodes designed to store URLs, text payloads, or contact credentials.',
    benefits: [
  ...
  'barcode-generator': {
    longDescription:
      'A Barcode Generator translates alphanumeric strings into visual EAN/CODE128 line sequences for scanning.',
    benefits: [
  ...
  'jpg-converter': {
    longDescription:
      'An Image to JPG converter translates PNG, WebP, GIF, or BMP files to JPEG format client-side.',
    benefits: [
  ...
  'webp-converter': {
    longDescription:
      'A WebP converter compresses standard image formats into highly efficient WebP files for web optimization.',
    benefits: [
  ...
  'color-palette': {
    longDescription:
      'A Color Palette Extractor identifies dominant colors in uploaded photographs using K-Means clustering algorithms.',
    benefits: [
  ...
  'favicon-generator': {
    longDescription:
      'A Favicon Generator converts square logos into standardized favicon sizes for browser tabs, iOS Apple Touch, and Android.',
    benefits: [
  ...
  'scientific-calculator': {
    longDescription:
      'A Scientific Calculator computes advanced mathematical calculations including trigonometry, logarithms, power exponents, and factorials.',
    benefits: [
  ...
  'age-calculator': {
    longDescription:
      'An Age Calculator calculates accurate intervals between two dates, listing elapsed years, months, weeks, days, and countdowns to birthdays.',
    benefits: [
  ...
  'percentage-calculator': {
    longDescription:
      'A Percentage Calculator calculates percentage changes, percentage ratios, and percentage increases/decreases across 6 distinct math modules.',
    benefits: [
  ...
  'cgpa-calculator': {
    longDescription:
      'A CGPA Calculator tracks and calculates GPA benchmarks (on 4.0 and 10.0 scales) across semesters and subjects.',
    benefits: [
  ...
  'bmi-calculator': {
    longDescription:
      'A BMI (Body Mass Index) Calculator evaluates baseline body mass categorizations (underweight, normal, overweight, obese) using height and weight metrics.',
    benefits: [
  ...
  pomodoro: {
    longDescription:
      'The Pomodoro Technique is a time management method developed by Francesco Cirillo in the late 1980s. It uses a kitchen timer to break work down into intervals, traditionally 25 minutes in length, separated by short breaks.',
    benefits: [
    ...
    howToSteps: [
      {
        ...
        text: 'Focus on your task until the 25-minute timer finishes.',
      },
  ...
  todo: {
    longDescription:
      'A To-Do List is a task organizer that manages daily routines, checklists, priorities, and deadlines.',
    benefits: [
  ...
  'habit-tracker': {
    longDescription:
      'A Habit Tracker logs weekly routines, streaks, and long-term habits using contribution heatmaps to boost consistency.',
    benefits: [
