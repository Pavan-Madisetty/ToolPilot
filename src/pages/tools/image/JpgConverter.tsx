...
export default function JpgConverter() {
  ...
  const handleConvert = () => {
    ...
    setTimeout(() => {
      ...
      if (ctx) {
        // Draw white background (since JPG doesn't support transparency, any transparent parts will be white)
        ...
        {!image && (
          ...
          >
            ...
            <p className="text-base font-semibold" style={{ color: 'var(--text-primary)' }}>
              Click to select or drag and drop PNG, WebP, GIF, BMP image to convert to JPG
            </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between items-center text-xs font-semibold">
                    <span style={{ color: 'var(--text-secondary)' }}>JPG Quality</span>
