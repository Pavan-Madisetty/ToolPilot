...
export default function PersonalLoanCalculator() {
  const [principal, setPrincipal] = useState(500000); // ₹5 Lakhs default for Personal Loan
  const [rate, setRate] = useState(12.0); // 12% interest
  const [tenureYears, setTenureYears] = useState(5); // 5 years default for Personal Loan
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute('download', 'Personal_Loan_Amortization_Schedule.csv');
  ...
  return (
    <ToolPageWrapper toolId="personal-loan-calculator">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 card flex flex-col justify-center gap-4">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Download the complete monthly payment schedule showing principal and interest components breakdown for the entire tenure of your Personal Loan.
              </p>
              <Button
                variant="secondary"
                onClick={downloadCSV}
