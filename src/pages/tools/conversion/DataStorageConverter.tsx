...
export default function DataStorageConverter() {
  ...
  const convertedValue = useMemo(() => {
    ...
    const fromFactor = baseType === 'decimal' ? fromUnitOpt.factorDecimal : fromUnitOpt.factorBinary;
        ...
        <div className="space-y-6">
          <Card className="space-y-6">
            ...
            <div className="p-4 rounded-xl space-y-2 text-xs" style={{ backgroundColor: 'var(--bg-elevated)', border: '1px solid var(--border-default)', color: 'var(--text-secondary)' }}>
              <p>
                <strong>Decimal System (Base 10):</strong> Standards used by disk storage manufacturers (e.g. 1 KB = 1000 Bytes).
              </p>
              <p>
                <strong>Binary System (Base 2):</strong> Standards used by operating systems (e.g. 1 KiB = 1024 Bytes).
              </p>
            </div>
          </Card>
        </div>
